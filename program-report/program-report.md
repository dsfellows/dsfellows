# Intro - testimonials from fellows
...
# fellows' bios, headshots, and class years

copy from [this page](http://upenndigitalscholarship.org/dsfellows16/cohort2016/)

also, team member bios?
...
[use one of Alice's special collections photos]
...
[image - go back and photograph things in special collections]

They also explored William Penn's [title tk], which included his initial plan for the city of Philadelphia, organized around five public squares--one of the inspirations for this year's Monument Lab sites.
...
[images of ML proposals? other ML-related materials?]
...
Andres De los Rios went on to use Jekyll to build a professional website, hosting the files Github Pages as we'd practiced during the session.

[Andres's website](https://afrivers.github.io/website/)

[someone's visualization of how Git works? screenshot of a simple jekyll site? of the file structure of a simple Jekyll site?]
...
This session introduced the Fellows to metadata, the "data about data" that powers so much of the digital (and library) worlds. Each Fellow took ten minutes to sketch out their own Monument Lab proposal using the official Monument Lab form. Topics ranged from [examples tk- look back at the forms]

[images of a few of the fellows' proposals]
...
[image of spreadsheet with additional sentence of commentary](https://docs.google.com/spreadsheets/d/1jF9mQ_3x6tBwN7NIXqiGCHloE9pND46-LntBAjA8m0I/edit?usp=sharing)
...
[screenshots of example maps, maybe also visualizations of individual data sets? visual representation of structure of a geojson data set?]
...
[Nick's Monument Lab project](https://njoyn.carto.com/builder/a7b6bdb0-26d8-11e7-b6ad-0ee66e2c9693/embed)
...
[image of a topic model; maybe also image of the number spreadsheet Scott's topic modeling tool generates- back end]

[additional sentence about what this tells us about Philly, what trends we saw]
...
[see if someone will let us use their site as an example]
...
do this as a very simple, one-page jekyll/other site?
